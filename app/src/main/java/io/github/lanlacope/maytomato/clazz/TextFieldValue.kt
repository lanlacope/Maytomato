...
import io.github.lanlacope.rewheel.util.getTextAfterSelectionSuffix
import io.github.lanlacope.rewheel.util.getTextBeforeSelectionPrefix
...
fun TextFieldValue.convertDecimalSelectedText(): TextFieldValue {
    ...
    val newCursor = getTextBeforeSelectionPrefix().length + convertedText.length
