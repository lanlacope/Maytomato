...
fun CommandAddDialog(
    ...
    GrowDialog(
        title = stringResource(id = R.string.dialog_title_command_add),
        expanded = expanded,
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            OutlinedInputTextField(
                ...
                hintText = stringResource(id = R.string.hint_command_title),
                isError = isError,
...
fun CommandEditDialog(
    ...
    GrowDialog(
        title = stringResource(id = R.string.dialog_title_command_edit),
        expanded = expanded,
...
fun CommandRemoveDialog(
    ...
    GrowDialog(
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Text(
                text = stringResource(id = R.string.confirm_text_command_remove),
                fontSize = 16.sp,
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(start = 16.dp)
